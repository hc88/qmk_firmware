...
#define LL_SPC LT(LOWER, KC_SPC)
#define RL_ENT LT(RAISE, KC_ENT)
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LL_SPC,  LL_SPC,  RL_ENT,  RL_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
